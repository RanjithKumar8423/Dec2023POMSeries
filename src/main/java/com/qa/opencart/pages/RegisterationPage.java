...
public class RegisterationPage {
	...
	public boolean userRegister(String firstName, String lastName, String email, 
		    ...
		    String userRegisterMes = eleutil.waitForElementVisible(sucessMessg, 10).getText();
		    System.out.println(userRegisterMes);
		    if (userRegisterMes.equals(AppsConstants.USER_REG_SUCCESS_MESSG)) {
